...
(function() {
  $(document).ready(function() {
    var ellipsis, lesstext, moretext, showChar;
    showChar = 150;
    ellipsis = " ...";
    moretext = "Read More";
    lesstext = "Close";
    $('.description').each(function() {
      var content, html, left, truncated;
      content = $(this).html();
      ...
      if (e.target.id === 'quantity') {
        ...
        return $.ajax({
          ...
          success: function(response) {
            ...
            return $("tr[order_item_id='" + id + "'] #total_price").text(response.total_price);
          },
    ...
    $('#dec_value').on('click', function(e) {
      var book_quantity;
      e.preventDefault();
      book_quantity = parseInt($(this).next()[0].value, 10);
      return $(this).next()[0].value = book_quantity <= 1 ? 1 : book_quantity - 1;
    });
    return $('#inc_value').on('click', function(e) {
      e.preventDefault();
      return $(this).prev()[0].value = 1 + parseInt($(this).prev()[0].value, 10);
    });
  });
